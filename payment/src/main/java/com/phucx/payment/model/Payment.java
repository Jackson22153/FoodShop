...
@NamedStoredProcedureQueries({
    @NamedStoredProcedureQuery(name = "Payments.saveFullPayment", procedureName = "SaveFullPayment",
    parameters = {
    ...
    @NamedStoredProcedureQuery(name = "Payments.savePayment", procedureName = "SavePayment",
    parameters = {
        @StoredProcedureParameter(name="paymentID", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="paymentDate", type = LocalDateTime.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="amount", type = Double.class, mode = ParameterMode.IN),
    ...
    @NamedStoredProcedureQuery(name = "Payments.updatePayment", procedureName = "UpdatePayment",
    parameters = {
        @StoredProcedureParameter(name="paymentID", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="transactionID", type = LocalDateTime.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="status", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="result", type = Boolean.class, mode = ParameterMode.OUT),
    }),
    @NamedStoredProcedureQuery(name = "Payments.updatePaymentStatus", procedureName = "UpdatePaymentStatus",
    parameters = {
        @StoredProcedureParameter(name="paymentID", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="status", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="result", type = Boolean.class, mode = ParameterMode.OUT),
    }),
    @NamedStoredProcedureQuery(name = "Payments.updatePaymentStatusByOrderID", procedureName = "UpdatePaymentStatusByOrderID",
    parameters = {
        @StoredProcedureParameter(name="orderID", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="status", type = String.class, mode = ParameterMode.IN),
        @StoredProcedureParameter(name="result", type = Boolean.class, mode = ParameterMode.OUT),
