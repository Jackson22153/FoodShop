...
import com.phucx.payment.service.paymentHandler.MomoHandlerService;
...
public class PaymentProcessorImpService implements PaymentProcessorService {
    ...
    public PaymentResponse createPayment(PaymentDTO payment) throws PayPalRESTException {
        ...
        switch (method) {
            ...
            case MOMO:
                String payUrl = this.momoHandler(payment);
                paymentResponse.setRedirect_url(payUrl);
                break;
    ...
    // momo method handler
    private String momoHandler(PaymentDTO payment){
        log.info("momoHandler(payment={})", payment);
        String payUrl = momoHandlerService.createPayment(payment);
        return payUrl;
    }
