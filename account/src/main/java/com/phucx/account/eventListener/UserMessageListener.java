...
public class UserMessageListener {
    ...
    public String fetchUser(String message){
        ...
        try {
            ...
            // fetch data
            if(userDTO.getEventType().equals(EventType.GetCustomerByID)){
                // get customer by id
            ...
            }else if(userDTO.getEventType().equals(EventType.GetCustomerByUserID)){
            ...
            }else if(userDTO.getEventType().equals(EventType.GetCustomersByID)){
            ...
            }else if(userDTO.getEventType().equals(EventType.GetEmployeeByID)){
                // get employee by id
            ...
            }else if(userDTO.getEventType().equals(EventType.GetUserByCustomerID)){
            ...
            }else if(userDTO.getEventType().equals(EventType.GetShipperByID)){
                // get shipper by id
