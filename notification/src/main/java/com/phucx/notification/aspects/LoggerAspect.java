package com.phucx.notification.aspects;
...
public class LoggerAspect {
    @Around("execution(* com.phucx.notification.service.*.*.*(..))")
    ...
    @Around("execution(* com.phucx.notification.controller.ExceptionController.*(..))")
    ...
    @Around("@annotation(com.phucx.notification.annotations.LoggerAspect)")
