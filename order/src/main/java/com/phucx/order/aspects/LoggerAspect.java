package com.phucx.order.aspects;
...
public class LoggerAspect {
    @Around("execution(* com.phucx.order.service.*.*.*(..))")
    ...
    @Around("execution(* com.phucx.order.controller.ExceptionController.*(..))")
    ...
    @Around("@annotation(com.phucx.order.annotations.LoggerAspect)")
