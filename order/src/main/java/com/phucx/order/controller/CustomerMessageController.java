...
//     @SendTo("/topic/order")
//     public OrderDetailDTO placeOrder(Authentication authentication, @RequestBody OrderWithProducts order
//     ) throws InvalidDiscountException, NotFoundException, RuntimeException, SQLException, InvalidOrderException{
//         OrderDetailDTO pendingOrder = customerService.placeOrder(order, authentication);
//         return pendingOrder;
//     }
